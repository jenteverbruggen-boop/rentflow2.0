...
| `PUT` | `/api/materials/:id` | Update a material (name, category, dayPrice, `setupCost`, notes, `isBundle`, `bundlePriceOverride` — a fixed set price, or `null` for the automatic component sum) |
