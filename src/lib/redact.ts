...
// findRejectedField/findRejectedMoneyWrite (the write-side guard, as
// opposed to this file's read-side redaction) live in
// src/lib/money-write-guard.ts — kept separate to stay under the
// 150-line file limit.
