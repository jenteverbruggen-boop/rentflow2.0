...
import { redactMoney, moneyVisible } from "./redact";
...
// findRejectedField/findRejectedMoneyWrite (the write-side guard) have
// their own test file: money-write-guard.test.ts.
